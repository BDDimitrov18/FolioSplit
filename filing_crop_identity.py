...
def prompt(page):
    return '''Read this cropped part of ONE page independently. Copy the visible project references carefully.
Count every Roman numeral letter in the regulated plot, and distinguish a printed ПИ label from identifier digits.
Never invent unreadable handwritten characters. Identify the visible document form when possible.
